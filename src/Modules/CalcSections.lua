...
}, }, { defaultCollapsed = false, label = "Recovery Between Hits", data = {
	colWidth = 114,
	extra = colorCodes.LIFE.."{1:output:LifeEHPRecoveryBetweenHits}, "..colorCodes.MANA.."{1:output:ManaEHPRecoveryBetweenHits}, "..colorCodes.ES.."{1:output:EnergyShieldEHPRecoveryBetweenHits}",
	{ label = "Enemy action time", haveOutput = "EHPRecoveryDamagingHitInterval", { format = "{2:output:enemySkillTime}s", }, },
	{ label = "Damaging hit chance", haveOutput = "EHPRecoveryDamagingHitInterval", { format = "{0:output:EHPRecoveryHitChance}%", { breakdown = "EHPRecoveryHitChance" }, }, },
	{ label = "Time between damaging hits", haveOutput = "EHPRecoveryDamagingHitInterval", { format = "{2:output:EHPRecoveryDamagingHitInterval}s", { breakdown = "EHPRecoveryDamagingHitInterval" }, }, },
	{ label = "Hits Survived", haveOutput = "EHPRecoveryHitsSurvived", { format = "{2:output:EHPRecoveryHitsSurvived}", { breakdown = "EHPRecoveryHitsSurvived" }, }, },
	{ label = "Survival Time", haveOutput = "EHPRecoverySurvivalTime", { format = "{2:output:EHPRecoverySurvivalTime}s", { breakdown = "EHPRecoverySurvivalTime" }, }, },
	{
		{ format = colorCodes.LIFE.."Life:" },
		{ format = colorCodes.MANA.."Mana:" },
		{ format = colorCodes.ES.."Energy Shield:" },
	},
	{ label = "Net Recovery", haveOutput = "EHPRecoveryDamagingHitInterval",
		{ format = "{1:output:LifeEHPRecoveryRate}", { breakdown = "LifeEHPRecoveryRate" } },
		{ format = "{1:output:ManaEHPRecoveryRate}", { breakdown = "ManaEHPRecoveryRate" } },
		{ format = "{1:output:EnergyShieldEHPRecoveryRate}", { breakdown = "EnergyShieldEHPRecoveryRate" } },
	},
	{ label = "Leech / On Hit", haveOutput = "EHPRecoveryDamagingHitInterval",
		{ format = "{1:output:LifeEHPLeechRate}", { breakdown = "LifeEHPLeechRate" } },
		{ format = "{1:output:ManaEHPLeechRate}", { breakdown = "ManaEHPLeechRate" } },
		{ format = "{1:output:EnergyShieldEHPLeechRate}", { breakdown = "EnergyShieldEHPLeechRate" } },
	},
	{ label = "Recoup", haveOutput = "EHPRecoveryDamagingHitInterval",
		{ format = "{1:output:LifeEHPRecoupRate}", { breakdown = "LifeEHPRecoupRate" } },
		{ format = "{1:output:ManaEHPRecoupRate}", { breakdown = "ManaEHPRecoupRate" } },
		{ format = "{1:output:EnergyShieldEHPRecoupRate}", { breakdown = "EnergyShieldEHPRecoupRate" } },
	},
	{ label = "Recharge", haveOutput = "EHPRecoveryDamagingHitInterval",
		{ format = "{1:output:LifeEHPRechargeRate}", { breakdown = "LifeEHPRechargeRate" } },
		{ format = "{1:output:ManaEHPRechargeRate}", { breakdown = "ManaEHPRechargeRate" } },
		{ format = "{1:output:EnergyShieldEHPRechargeRate}", { breakdown = "EnergyShieldEHPRechargeRate" } },
	},
	{ label = "Between Hits", haveOutput = "EHPRecoveryDamagingHitInterval",
		{ format = "{1:output:LifeEHPRecoveryBetweenHits}", { breakdown = "LifeEHPRecoveryBetweenHits" } },
		{ format = "{1:output:ManaEHPRecoveryBetweenHits}", { breakdown = "ManaEHPRecoveryBetweenHits" } },
		{ format = "{1:output:EnergyShieldEHPRecoveryBetweenHits}", { breakdown = "EnergyShieldEHPRecoveryBetweenHits" } },
	},
	{ label = "Loss Per Hit", haveOutput = "EHPRecoveryDamagingHitInterval",
		{ format = "{1:output:LifeEHPLossPerHit}", { breakdown = "LifeEHPLossPerHit" } },
		{ format = "{1:output:ManaEHPLossPerHit}", { breakdown = "ManaEHPLossPerHit" } },
		{ format = "{1:output:EnergyShieldEHPLossPerHit}", { breakdown = "EnergyShieldEHPLossPerHit" } },
	},
	{ label = "Net Loss Per Hit", haveOutput = "EHPRecoveryDamagingHitInterval",
		{ format = "{1:output:LifeEHPNetLossPerHit}", { breakdown = "LifeEHPNetLossPerHit" } },
		{ format = "{1:output:ManaEHPNetLossPerHit}", { breakdown = "ManaEHPNetLossPerHit" } },
		{ format = "{1:output:EnergyShieldEHPNetLossPerHit}", { breakdown = "EnergyShieldEHPNetLossPerHit" } },
	},
