...
{ 3, "DamageTaken", 1, colorCodes.DEFENCE, {{ defaultCollapsed = false, label = "Damage Taken", data = {
	...
	colWidth = 114,
	extra = "{output:EHPRecoveryStatus}",
	{ label = "Damage / hit", haveOutput = "EHPRecoveryDamagePerHit", { format = "{1:output:EHPRecoveryDamagePerHit}", { breakdown = "EHPRecoveryDamagePerHit" }, }, },
	{ label = "Time / hit", haveOutput = "EHPRecoveryDamagingHitInterval", { format = "{2:output:EHPRecoveryDamagingHitInterval}s", { breakdown = "EHPRecoveryDamagingHitInterval" }, }, },
	...
	{ label = "Status", haveOutput = "EHPRecoveryStatus", { format = "{output:EHPRecoveryStatus}", { breakdown = "EHPRecoveryStatus" }, }, },
	{
		{ format = "{output:EHPRecoveryLifeHeader}" },
		{ format = "{output:EHPRecoveryManaHeader}" },
		{ format = "{output:EHPRecoveryEnergyShieldHeader}" },
	},
	{ label = "Loss", haveOutput = "EHPRecoveryDamagingHitInterval",
		{ format = "{output:LifeEHPLossPerHitDisplay}", { breakdown = "LifeEHPLossPerHit" } },
		{ format = "{output:ManaEHPLossPerHitDisplay}", { breakdown = "ManaEHPLossPerHit" } },
		{ format = "{output:EnergyShieldEHPLossPerHitDisplay}", { breakdown = "EnergyShieldEHPLossPerHit" } },
	},
	{ label = "Gain / hit", haveOutput = "EHPRecoveryHasGainPerHit",
		{ format = "{output:LifeEHPGainPerHitDisplay}", { breakdown = "LifeEHPGainPerHit" } },
		{ format = "{output:ManaEHPGainPerHitDisplay}", { breakdown = "ManaEHPGainPerHit" } },
		{ format = "{output:EnergyShieldEHPGainPerHitDisplay}", { breakdown = "EnergyShieldEHPGainPerHit" } },
	},
	{ label = "Recovery", haveOutput = "EHPRecoveryHasRecoveryRow",
		{ format = "{output:LifeEHPRecoveryBetweenHitsDisplay}", { breakdown = "LifeEHPRecoveryBetweenHits" } },
		{ format = "{output:ManaEHPRecoveryBetweenHitsDisplay}", { breakdown = "ManaEHPRecoveryBetweenHits" } },
		{ format = "{output:EnergyShieldEHPRecoveryBetweenHitsDisplay}", { breakdown = "EnergyShieldEHPRecoveryBetweenHits" } },
	},
	{ label = "Net Loss", haveOutput = "EHPRecoveryDamagingHitInterval",
		{ format = "{output:LifeEHPNetLossPerHitDisplay}", { breakdown = "LifeEHPNetLossPerHit" } },
		{ format = "{output:ManaEHPNetLossPerHitDisplay}", { breakdown = "ManaEHPNetLossPerHit" } },
		{ format = "{output:EnergyShieldEHPNetLossPerHitDisplay}", { breakdown = "EnergyShieldEHPNetLossPerHit" } },
	},
